...
def _create_tweet_dataframe(tweet_generator):
    count = int(input("Tweets to store: "))
    tweet_dataframe = np.fromiter(tweet_generator, dtype=sn.Tweet, count=count)
    print(type(tweet_generator))
    print(type(tweet_dataframe))
...
if __name__ == "__main__":
    ...
    if input("Store as excel(y/n)?: ") == 'y':
        ...
        tweet_dataframe = _create_tweet_dataframe(tweet_generator)
